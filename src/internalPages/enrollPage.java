 ...
 * @author SCC-MIKE
 */
public class enrollPage extends javax.swing.JInternalFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT tbl_student.s_id, "
                    + "tbl_student.s_lname, "
                    + "tbl_student.s_fname, "
                    + "tbl_department.dept_code "
                    + "FROM tbl_enrollee "
                    + "LEFT JOIN tbl_student ON tbl_enrollee.s_id = tbl_student.s_id "
                    + "LEFT JOIN tbl_department ON tbl_enrollee.dept_id = tbl_department.dept_id");
